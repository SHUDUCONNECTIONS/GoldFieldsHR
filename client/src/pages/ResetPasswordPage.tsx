          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <label className="flex flex-col gap-1 text-sm text-slate-700">
              ...
              <textarea
                ...
                className="rounded-md border border-slate-300 px-3 py-2 font-mono text-xs transition-shadow focus:border-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/15"
              />
            </label>
